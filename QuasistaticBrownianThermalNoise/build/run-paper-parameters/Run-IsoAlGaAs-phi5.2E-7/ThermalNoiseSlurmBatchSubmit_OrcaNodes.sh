...
mpirun -np 420 QuasistaticBrownianThermalNoise --configuration=./config.yaml --configuration_multloss=./config_multloss.yaml &> QuasistaticBrownianThermalNoise.out
